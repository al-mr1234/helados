...
import Logo1 from '../../estilos/img/productos/ensaladas1.png';
import Logo2 from '../../estilos/img/productos/ensaladas2.png';
import Logo3 from '../../estilos/img/productos/ensaladas3.png';
...
export default function SimpleSlider() {
    ...
    return (
      <div style={{ padding: '30px', background: 'linear-gradient(90deg, #EFD7EF 8%, #F5F9FC 39%, #F8EAE1 66%, #EAF8F9 91%)' }}>
        <h2 className="text-center mb-4" style={{ color: '#F83D8E' }}>Ensaladas de Frutas</h2>
        <Slider {...settings}>
